...
double rs_rab(long long P, long long m, long long ms, double alpha_beta_gamma[3][NUM_ALGOS+1], ll * Pc_ptr){
	long long pow1 = 1;
	...
	*Pc_ptr = Pc_opt;
	times41[RING_SEG_ALL_REDUCE][RABENSEIFNER_ALL_REDUCE] = t_opt;
	return t_opt;
}
